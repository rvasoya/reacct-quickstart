...
This repo is for only starting react project with simple understading.

These are the things I stripped out from [react-boilerplate](https://github.com/react-boilerplate/react-boilerplate) - _github project rules, ngrok tunneling, shjs, service worker, webpack dll plugin, styled-components, code generators and a few more._
...
MIT license, Copyright (c) 2018 Alyzer.
